namespace DAL.Migrations
{
    ...
    public partial class order_and_order_item : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"insert into tbl_orders (cln_total_price) values (82.00)");
            Sql(@"insert into tbl_orders (cln_total_price) values (10750.00)");

            Sql(@"insert into tbl_order_items (cln_order_id, cln_item_id) values (1, 1)");
            Sql(@"insert into tbl_order_items (cln_order_id, cln_item_id) values (1, 2)");
            Sql(@"insert into tbl_order_items (cln_order_id, cln_item_id) values (1, 3)");
            Sql(@"insert into tbl_order_items (cln_order_id, cln_item_id) values (2, 1)");
            Sql(@"insert into tbl_order_items (cln_order_id, cln_item_id) values (2, 2)");
        }
